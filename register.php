...
-->
   ...
   <?php include 'header.php' ?>
    ...
    <section class="section" id="reservation">
      ...
      <input type="text" name="fname" id = "" required value="" placeholder="Enter First Name"> <br>

      <input type="text" name="lname" id = "" required value="" placeholder="Enter Last Name"> <br>

      <input type="email" name="email" id = "" required value=""  placeholder="Enter email" > <br>

      <input type="number" name="phone" id = "" required value=""  placeholder="Enter Phone number" > <br>

      <input type="text" name="county"  required value=""  placeholder="Enter your county" > <br>
      
      <input type="password" name="password" id = "" required value="" placeholder="Enter password"> <br>

      <input type="password" name="cpassword" id = "" required value="" placeholder="Confirm Password"> <br>
